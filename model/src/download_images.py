...
if __name__ == "__main__":
    ...
    parser.add_argument("-q", "--query", help="The search query for DuckDuckGo", required=True)
    parser.add_argument("-n", "--num_images", type=int, help="The number of images to download", default=5)
    parser.add_argument("-f", "--folder_path", help="The path where the images will be saved", required=True)
